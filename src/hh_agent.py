...
class VacancyClassificationAgent:
    ...
    def __init__(self, model_name: str = "GigaChat-2", temperature: float = 0.1):
        """Инициализация агента"""
        self.llm = GigaChat(model="GigaChat-2", credentials=os.getenv("GIGACHAT_API_KEY"), verify_ssl_certs=False,
    ...
    async def _classify_job_type(self, state: State) -> Dict[str, Any]:
        ...
        Logger.message('_classify_job_type: ' + job_type)
    ...
    async def _classify_category(self, state: State) -> Dict[str, Any]:
        ...
        Logger.message('_classify_category: ' + category)
    ...
    async def _classify_search_type(self, state: State) -> Dict[str, Any]:
        ...
        Logger.message('_classify_search_type: ' + category)
    ...
    async def _calculate_confidence(self, state: State) -> Dict[str, Any]:
        ...
        response = await self.llm.ainvoke([message])
        Logger.message('_calculate_confidence: ' + category)

        try:
            confidence_scores = json.loads(response.content.strip())
            Logger.message('Успешно _calculate_confidence: ' + response.content.strip())
            ...
            Logger.message('Fallback значения _calculate_confidence')
